  ...
  var pageSwiper = new Swiper('#page', {
    ...
    on: {
        ...
        slideChangeTransitionStart: function(){
          ...
          $(".tab-menu span").eq(this.activeIndex).addClass('active');
        },
  ...
  var scrollSwiper = new Swiper('.scroll', {
    ...
    on: {
        touchMove: function() {
            ...
            if (this.translate > 72 - 50 && this.translate < 72) {
        ...
        touchEnd: function() {
            ...
            if (this.translate > 50 && this.translate < 72 && this.translate < startPosition) {
                topBar.transform('translateY(-50px)');
